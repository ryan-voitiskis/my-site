import { c as create_ssr_component, b as add_attribute, d as subscribe, v as validate_component } from "../../chunks/index.js";
...
const ThemeToggle = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<label class="${"theme-toggle svelte-uhfhf0"}"><input type="${"checkbox"}" class="${"svelte-uhfhf0"}"${add_attribute("checked", darkTheme2, 1)}>
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  $$unsubscribe_page();
  return `<header class="${"svelte-16p1xve"}"><nav class="${"svelte-16p1xve"}"><a href="${"/"}" class="${["svelte-16p1xve", $page.route.id === "/" ? "active" : ""].join(" ").trim()}">about</a>
		<a href="${"/blog"}" class="${["svelte-16p1xve", $page.route.id === "/blog" ? "active" : ""].join(" ").trim()}">blog</a>
		<a href="${"/projects"}" class="${["svelte-16p1xve", $page.route.id === "/projects" ? "active" : ""].join(" ").trim()}">projects</a></nav>
