...
const Stable_diffusion_collection_4 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  const images = [
    {
      src: img1,
      alt: "AI generated image of an ancient alien."
    },
    {
      src: img2,
      alt: "AI generated image of an ancient alien."
...
export {
  Stable_diffusion_collection_4 as default,
  metadata
};
